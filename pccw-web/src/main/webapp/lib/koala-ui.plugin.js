 ...
 */ + function($) {"use strict";
	var ModifyPassword = function(container, option) {
		...
		this.oldPwd.on('blur.do.modifyPassowrd', $.proxy(this.blur, this, this.oldPwd));
		this.newPwd.on('blur.do.modifyPassowrd', $.proxy(this.blur, this, this.newPwd));
		this.confirmPwd.on('blur.do.modifyPassowrd', $.proxy(this.blur, this, this.confirmPwd));
		this.$element.find('.modal-footer button[data-toggle="save"]').on('click.do.modifyPassowrd', $.proxy(this.save, this));
	};
