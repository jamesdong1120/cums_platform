...
var changePost = function(){
		...
		$.get( contextPath + '/pages/organisation/changePost.jsp').done(function(data){
            ...
            dialog.find('#save').on('click',function(){
				...
				$.ajax({
				    ...
				    'type': "Post",
				    'url': contextPath + '/employee/transform-post.do?employeeId='+employeeId,
	...
	var loadData =  function(employeeId){
		$.get( contextPath + '/employee/get/'+employeeId+'.do')
	...
	var loadExistPostList = function(employeeId){
		$.get( contextPath + '/employee/get-posts-by-employee.do?employeeId='+employeeId).done(function(data){
	...
	var loadDepartmentTree = function(employeeId){
        ...
        $.get(contextPath  + '/organization/orgTree.do').done(function(data){
	...
	var loadPostList = function(id, hostOrgId){
		...
		$.post(contextPath + '/post/paging-query-post-by-org.do?organizationId='+id,{pagesize:10,page:0},function(result){
			var existIds = [];
